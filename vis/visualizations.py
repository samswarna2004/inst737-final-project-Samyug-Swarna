...
def make_visualizations(
    ...
    """
    Create basic project visualizations.

    This function generates a small set of project charts based on the columns
    available in the input DataFrame. The charts are saved as image files in the
    specified output directory.

    Paramters
        df : pd.DataFrame
            The dataset used to create the visualizations.
        output_dir : str | Path, default="data/visualizations"
            The folder where the chart image files will be saved.
    
    Returns
        Nothing
            Just saves the visulizations files
